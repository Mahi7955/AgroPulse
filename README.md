...
***#🛠️ Technologies Used in AgroPulse****
**Frontend**

React 18 – Build interactive user interfaces
...
Supabase Edge Functions (Deno) – Serverless APIs
...
Soil type analysis
Gemini AI Gateway – Secure Gemini API access
